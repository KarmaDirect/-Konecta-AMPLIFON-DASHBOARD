  ...
  return (
    <Card className="col-span-full">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div>
          <CardTitle className="text-xl">Activité de l'équipe</CardTitle>
          <CardDescription>
            Suivez en temps réel les actions de votre équipe
          </CardDescription>
        </div>
            ...
            {filteredActivities.slice(0, displayCount).map((activity) => (
              <div key={activity.id} className="flex items-start space-x-4">
                <Avatar className="h-8 w-8">
                  <AvatarFallback>{getUserInitials(activity.userName)}</AvatarFallback>
                </Avatar>
                <div className="flex-1 space-y-1">
                  <div className="flex items-center">
                    ...
                    <Badge className="ml-2" variant="outline">
                      ...
                      <span className="ml-1">{getActionType(activity.action)}</span>
                    </Badge>
              ...
              >
                {isExpanded ? (
                  ...
                  <>
                    ...
                    Afficher plus ({filteredActivities.length - 5} activités)
                  </>
                )}
              </Button>
            )}
